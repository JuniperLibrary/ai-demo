...
from customer_service.app.core.config import settings
    ...
    def __init__(self):
        self.config = {
            ...
            "embedder": {
                ...
                "config": {
                    "schemas": settings.EMBEDDINGING_MODEL,
                    "openai_base_url": settings.EMBEDDINGING_BASE_URL,
                    "api_key": settings.EMBEDDINGING_API_KEY,
